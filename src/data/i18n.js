...
export const i18nData = {
  en: {
    ...
    'config.deviceTooltip': 'Currently only iPhone devices are available; Android support will be added in a future release.',
  ...
  'zh-CN': {
    ...
    'config.device': '设备',
    'config.deviceTooltip': '目前仅开放 iPhone 设备；Android 将在后续版本开放。',
  ...
  'zh-TW': {
    ...
    'config.device': '裝置',
    'config.deviceTooltip': '目前僅開放 iPhone 裝置；Android 將在後續版本開放。',
  ...
  ja: {
    ...
    'config.device': 'デバイス',
    'config.deviceTooltip': '現在は iPhone デバイスのみ利用可能です。Android は今後のバージョンで対応予定です。',
