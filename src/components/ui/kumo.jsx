 ...
 * [OUTPUT]: 对外提供 Registry 页面层统一 UI 入口（Button/LinkButton/Input/Select/DatePicker/Text/Badge/Banner/Dialog/Tooltip/TooltipProvider/Switch/Checkbox/Collapsible/Combobox/DropdownMenu/LayerCard/ClipboardText/SkeletonLine/Tabs）
