 ...
 * [POS]: registry/sections/workspace 的右侧设置面板，负责卡片编排、空态引导与 pane 级 Guide 宿主，Set-it/AutoFlow/effectiveLayoutTier 状态由 HomeGrid 上提统一管理（`md + 抽屉关闭` 通过父层局部改写为 pane 级 mid）
