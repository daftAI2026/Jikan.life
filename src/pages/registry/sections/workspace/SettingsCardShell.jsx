/**
 * [INPUT]: 依赖父层传入 cardId/legacyCardId/title/titleTooltip/indexMark/children/className、Tooltip 原语、cn() 与 Kumo token 样式
 * [OUTPUT]: 对外提供 SettingsCardShell 组件（左上标题 + 可选问号提示 + 右上序号 + 居中内容 + 新旧ID兼容选择器 + 壳层布局扩展）
...
function SettingsCardShell({ cardId, legacyCardId, title, titleTooltip, indexMark, children, className }) {
    return (
        <article
