/**
 * [INPUT]: 依赖 react(useState), react-router-dom, registry/sections (RegistryTopbar/Sidebar/ThemeToggle/HomeGrid)
 * [OUTPUT]: 对外提供 RegistryHome 页面组件
 * [POS]: pages/registry 的路由入口，维护 selectedStyle 单一真相源并编排 preview|settings 双栏工作区
