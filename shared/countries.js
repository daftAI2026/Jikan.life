/**
 * [INPUT]: 无
 * [OUTPUT]: 对外提供 countries 列表、countryTimezones 映射、getTimezone
 * [POS]: shared/ 跨端共享的国家/时区数据源，被 Worker 与 Frontend 复用
...
export const countryTimezones = Object.fromEntries(
  countries.map((country) => [country.code.toLowerCase(), country.timezone])
);
