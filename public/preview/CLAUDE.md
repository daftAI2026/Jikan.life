...
变更日志
2026-03-11: `lock-screen-controls.svg` 从 `public/preview/iPhone/` 下线；底部 Stack controls 改由 `src/pages/registry/sections/workspace/lock-screen-overlay/` live 渲染，public 目录仅继续托管 bezel 壳资源。
