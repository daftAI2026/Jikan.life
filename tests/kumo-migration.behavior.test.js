...
test("Goal url card uses setup title and set flow guarded by copy success", () => {
  ...
  assert.match(gridSource, /className="pointer-events-none fixed top-\[var\(--registry-topbar-height\)\] right-\[var\(--registry-tools-rail-width\)\] bottom-0 left-\[var\(--registry-rail-width\)\] z-40 hidden md:block lg:hidden"/)
