...
2026-03-04: 更新 `kumo-migration.ui.behavior.test.js`：新增 `mid + year` URL 收口卡护栏（`effectiveLayoutTier` 透传、`grid-cols-[minmax(0,1fr)_auto]`、`gap-2`、输入框可缩/按钮不缩）并保留非 mid 的 `md:px-[calc(25%-100px)]` 断言。
