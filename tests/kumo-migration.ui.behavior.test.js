...
test("HomeSettingsPane splits md drawer-open bottom-tabs layout from grid layout", () => {
  ...
  assert.match(bottomTabsSource, /const tabCount = bottomTabsCardOrder\.length/)
  assert.match(bottomTabsSource, /Array\.from\(\{ length: tabCount \}, \(_, [A-Za-z]+Index\) => \{/)
  ...
  assert.match(bottomTabsSource, /function resolveMdBottomTabTriggerClassName\(index, tabCount\)/)
  ...
  assert.match(bottomTabsSource, /className: resolveMdBottomTabTriggerClassName\(index, tabCount\)/)
