...
test("md breakpoint routes main scrolling to outer main-content container", () => {
  ...
  assert.match(homeGridSource, /\? "h-full grid-rows-\[auto_minmax\(0,1fr\)\] overflow-y-hidden"/)
  assert.match(homeGridSource, /: "md:h-\[calc\(100vh-var\(--registry-topbar-height\)\)\] md:grid-rows-\[auto_minmax\(0,1fr\)\] md:overflow-hidden"/)
