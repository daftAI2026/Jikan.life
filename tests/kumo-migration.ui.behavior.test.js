...
test("md breakpoint routes main scrolling to outer main-content container", () => {
  ...
  assert.match(homeGridSource, /const useMdBottomTabsLayout = effectiveLayoutTier === "md" && sidebarOpen/)
  assert.match(homeGridSource, /const workspaceLayoutClassName = useMdBottomTabsLayout/)
  ...
  assert.match(homeGridSource, /: "md:h-auto md:overflow-y-visible md:overscroll-y-auto"/)
  assert.match(homeGridSource, /const shouldRenderGridGuideHost = effectiveLayoutTier === "md" && sidebarOpen/)
  assert.match(homeGridSource, /const shouldRenderPaneGuideHost = !shouldRenderGridGuideHost/)
...
test("Goal url card uses setup title and set flow guarded by copy success", () => {
  ...
  assert.match(paneSource, /const shouldUseAnchoredSetupRow = effectiveLayoutTier === "mid" \|\| useMdBottomTabsLayout/)
...
test("HomeGrid provides split workspace layout", () => {
  ...
  assert.match(source, /const useMdBottomTabsLayout = effectiveLayoutTier === "md" && sidebarOpen/)
  assert.match(source, /const workspaceLayoutClassName = useMdBottomTabsLayout/)
  ...
  assert.match(source, /: "md:h-auto md:overflow-y-visible md:overscroll-y-auto"/)
  ...
  assert.match(source, /<HomeSettingsPane[\s\S]*?useMdBottomTabsLayout=\{useMdBottomTabsLayout\}/)
...
test("HomePage keeps md drawer-open height chain untouched outside active tabs mode", () => {
  ...
  assert.doesNotMatch(source, /const useMdBottomTabsLayout =/)
...
test("HomeSettingsPane splits md drawer-open bottom-tabs layout from grid layout", () => {
  ...
  assert.match(paneSource, /useMdBottomTabsLayout = false/)
  ...
  assert.match(paneSource, /if \(useMdBottomTabsLayout\) return <HomeSettingsPaneBottomTabsLayout/)
