...
life.js: 生命周历 SVG 生成器，依赖 shared/wallpaper-core.js 的 computeLifeLayout，输出 52 列周历网格，支持 foregroundOverride
goal.js: 目标倒计时 SVG 生成器，依赖 shared/wallpaper-core.js 的 computeGoalLayout/getWallpaperText，输出环形进度条，支持 foregroundOverride 与本地化 goalDefault
